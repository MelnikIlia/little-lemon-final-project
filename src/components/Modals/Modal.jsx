          ...
          <form className="form" onSubmit={formik.handleSubmit}>
            <div className="form-group">
              <div className="form-item">
                <input required type="text" name="name" id="name" placeholder="Name & Surname" onChange={formik.handleChange} value={formik.values.name} />
                <label htmlFor="name">
              ...
              <div className="form-item">
                <input required type="text" name="mail" id="mail" placeholder="Email Adress" onChange={formik.handleChange} value={formik.values.email} />
                <label htmlFor="mail">
            ...
            <div className="form-group">
              <div className="form-item">
                <input required type="tel" name="phone" id="phone" placeholder="Phone Number" onChange={formik.handleChange} value={formik.values.phoneNumber} />
                <label htmlFor="phone">
            ...
            <div className="form-group">
              <div className="form-item">
                <input required type="date" name="date" id="date" placeholder="Select Date" onChange={formik.handleChange} value={formik.values.date} />
                <label htmlFor="date">
              ...
              <div className="form-item">
                <input required type="time" name="time" id="time" placeholder="Select Time" onChange={formik.handleChange} value={formik.values.time} />
                <label htmlFor="time">
                  <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
